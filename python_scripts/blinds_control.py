...
def closeCover(cover_id):
    service_data = { 'entity_id': cover_id, 'position': 0 }
    hass.services.call('cover', 'set_cover_position', service_data, False)

def openCover(cover_id):
    service_data = { 'entity_id': cover_id, 'position': 100 }
    hass.services.call('cover', 'set_cover_position', service_data, False)
...
thresholdCoverIsClosed = 15
thresholdCoverIsOpen = 70
