class DarkSkyWeatherCard extends HTMLElement {
  set hass(hass) {
    ...
    const getUnit = function (measure) {
      const lengthUnit = 'km'//hass.config.core.unit_system.length;
      switch (measure) {
        case 'air_pressure':
        ...
        default:
          return "";
          //return homeassistant.util.unit_system[measure] || "" ;
          //return homeassistnat.config.core.unit_system[measure] || '';
      }
    };
